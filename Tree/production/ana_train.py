...
#使用的数据集和LR的一样，但是由于GBDT不需要将连续特征离散化，所以只需要修改一些代码就行
...
if __name__=="__main__":
    ana_train_data("../data/train.txt","../data/test.txt","../data/train_preprocess.txt","../data/test_preprocess.txt","../data/feature_num.txt")